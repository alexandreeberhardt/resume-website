...
% --- Section style ---
\titleformat{\section}{\bfseries\uppercase}{}{0em}{}[\vspace{-0.5em}\rule{\linewidth}{0.4pt}]
...
% === HEADER ===
\begin{center}
  {\LARGE\bfseries\VAR{personal.name | escape_latex}}\\[0.3em]
  \BLOCK{if personal.title}{\normalsize\VAR{personal.title | escape_latex}}\\[0.2em]\BLOCK{endif}
  {\small%
...
\BLOCK{if edu.subtitle}\\[0.1em]\VAR{edu.subtitle | escape_latex}\BLOCK{endif}
