  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f4f4f5;padding:40px 0;">
    <tr><td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;max-width:100%;">
        ...
        <tr>
          <td style="padding:40px;">
            <h2 style="margin:0 0 16px;color:#1e293b;font-size:22px;">V&eacute;rifiez votre adresse email</h2>
            <p style="margin:0 0 16px;color:#475569;font-size:16px;line-height:1.6;">
              Merci de vous &ecirc;tre inscrit sur Sivee.pro ! Cliquez sur le bouton ci-dessous pour v&eacute;rifier votre adresse email et activer votre compte.
            </p>
            <p style="margin:0 0 32px;color:#475569;font-size:16px;line-height:1.6;">
            ...
            <p style="margin:32px 0 0;color:#94a3b8;font-size:14px;line-height:1.6;">
              Si vous n'avez pas cr&eacute;&eacute; de compte sur Sivee.pro, ignorez cet email.
            </p>
          </td>
        </tr>
        <!-- Footer -->
