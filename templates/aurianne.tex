...
\usepackage{enumitem}
% itemsep ajusté à 1.5pt pour un bon équilibre
...
\titleformat{\section}
  ...
  {0pt}
  {}
  [\vspace{-1em}\rule{\linewidth}{0.4pt}\vspace{0.2em}]

% Espacement optimisé autour des sections pour gagner de la place
