...
% === HEADER ===
\begin{center}
  {\Huge\textbf{\VAR{personal.name | escape_latex}}}\\[0.25em]
  \BLOCK{if personal.title}{\large\color{accentcolor} \VAR{personal.title | escape_latex}}\\[0.25em]\BLOCK{endif}
  \BLOCK{if personal.github}\faGithub\ \href{\VAR{personal.github_url | escape_latex}}{\VAR{personal.github | escape_latex}} \quad\BLOCK{endif}
...
\textbf{Programming Languages:} \VAR{section.content.languages | escape_latex}
