      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="prose prose-primary dark:prose-invert max-w-none space-y-8">
          {isFrench ? (
            <>
              ...
              <section>
                ...
                <p className="text-primary-700">
                  ...
                  <a href="https://www.ovhcloud.com" className="text-brand hover:underline" target="_blank" rel="noopener noreferrer">www.ovhcloud.com</a>
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">3. Propriété intellectuelle</h2>
                <p className="text-primary-700">
                  L'ensemble du contenu du site Sivee.pro (textes, images, logos, design, code source)
                  est protégé par le droit d'auteur et reste la propriété exclusive de l'éditeur,
              ...
              <section>
                ...
                <p className="text-primary-700">
                  ...
                  Toutefois, il ne peut garantir l'exactitude, la complétude et l'actualité des informations.
                </p>
                <p className="text-primary-700">
                  L'utilisateur est seul responsable de l'utilisation qu'il fait du service et
                  des documents générés via Sivee.pro.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">5. Données personnelles</h2>
                <p className="text-primary-700">
            ...
            <>
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">1. Website Publisher</h2>
                <p className="text-primary-700">
                  The Sivee.pro website is published by:<br />
                  <strong>Alexandre Eberhardt</strong><br />
                  Individual<br />
                  Contact: <a href="mailto:contact@sivee.pro" className="text-brand hover:underline">contact@sivee.pro</a>
                </p>
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">3. Intellectual Property</h2>
                <p className="text-primary-700">
                ...
                <p className="text-primary-700">
                  ...
                  of all or part of the site is prohibited.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-primary-700">
                  ...
                  However, they cannot guarantee the accuracy, completeness and timeliness of the information.
                </p>
                <p className="text-primary-700">
                  The user is solely responsible for their use of the service and
                  documents generated via Sivee.pro.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-primary-700">
                  To learn more about the collection and processing of your personal data,
                  please see our{' '}
