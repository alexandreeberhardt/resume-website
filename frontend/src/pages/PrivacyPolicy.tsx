          ...
          {isFrench ? (
            <>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-primary-700 space-y-2">
                  <li>
                    <strong>Données de compte</strong> : adresse email, mot de passe (chiffré et non
                    lisible)
                  </li>
                  <li>
                    <strong>Données de CV</strong> : nom, titre professionnel, coordonnées, parcours
                    (formation, expériences, projets, compétences)
                  </li>
                  <li>
                    <strong>Données techniques</strong> : adresse IP (logs serveur), données de
                    navigation
                  </li>
                </ul>
                <p className="text-primary-700 mt-3 text-sm">
                  <em>
                    Note : si vous utilisez la connexion Google, nous recevons uniquement votre
                    adresse email et un identifiant technique anonyme permettant de vous
                    reconnecter. Nous n'avons jamais accès à votre mot de passe Google ni à vos
                    autres données Google.
                  </em>
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-primary-700">Le traitement de vos données repose sur :</p>
                <ul className="list-disc list-inside text-primary-700 space-y-2">
                  <li>
                    <strong>Exécution du contrat</strong> : fourniture du service de création de CV
                  </li>
                  <li>
                    <strong>Consentement</strong> : lors de la création de compte
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="text-primary-700">
                  Vos données sont uniquement transmises aux prestataires techniques nécessaires au
                  fonctionnement du service :
                </p>
                <ul className="list-disc list-inside text-primary-700 space-y-2">
                  <li>
                    <strong>Mistral AI</strong> (France) : uniquement pour l'extraction automatique
                    de CV importés
                  </li>
                  <li>
                    <strong>Amazon Web Services</strong> (France - eu-west-3) : stockage sécurisé
                    des fichiers PDF générés
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-primary-700 space-y-2">
                  <li>
                    <strong>Données de compte</strong> : conservées jusqu'à suppression du compte
                  </li>
                  <li>
                    <strong>Données de CV</strong> : conservées jusqu'à suppression par
                    l'utilisateur
                  </li>
                  <li>
            ...
            <>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-primary-700 space-y-2">
                  <li>
                    <strong>Account data</strong>: email address, password (encrypted and
                    unreadable)
                  </li>
                  <li>
                    <strong>Resume data</strong>: name, professional title, contact information,
                    background (education, experience, projects, skills)
                  </li>
                  <li>
                    <strong>Technical data</strong>: IP address (server logs), navigation data
                  </li>
                </ul>
                <p className="text-primary-700 mt-3 text-sm">
                  <em>
                    Note: if you use Google sign-in, we only receive your email address and an
                    anonymous technical identifier to recognize you on future logins. We never have
                    access to your Google password or any other Google data.
                  </em>
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-primary-700">The processing of your data is based on:</p>
                <ul className="list-disc list-inside text-primary-700 space-y-2">
                  <li>
                    <strong>Contract execution</strong>: providing the resume creation service
                  </li>
                  <li>
                    <strong>Consent</strong>: when creating an account
                  </li>
                  <li>
                    <strong>Legitimate interest</strong>: security and service improvement
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <div className="p-4 bg-success-50 dark:bg-success-900/20 border border-success-200 dark:border-success-800 rounded-lg mb-4">
                  <p className="text-success-800 dark:text-success-200 font-medium">
                    Your data is never sold, rented, or shared for commercial or advertising
                    purposes.
                  </p>
                </div>
                <p className="text-primary-700">
                  Your data is only transmitted to technical providers required for the service to
                  function:
                </p>
                <ul className="list-disc list-inside text-primary-700 space-y-2">
                  <li>
                    <strong>Mistral AI</strong> (France): only for automatic extraction of imported
                    resumes
                  </li>
                  <li>
                    <strong>Amazon Web Services</strong> (France - eu-west-3): secure storage of
                    generated PDF files
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-primary-700 space-y-2">
                  ...
                  <li>
                    <strong>Resume data</strong>: retained until deleted by user
                  </li>
                  <li>
                    <strong>Technical logs</strong>: 12 months maximum
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-primary-700 space-y-2">
                  ...
                  <li>
                    <strong>Right to rectification</strong>: correct your data
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="text-primary-700">We implement appropriate security measures:</p>
                <ul className="list-disc list-inside text-primary-700 space-y-2">
