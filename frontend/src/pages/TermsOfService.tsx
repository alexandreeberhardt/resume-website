          ...
          {isFrench ? (
            <>
              <section>
                ...
                <p className="text-primary-700">
                  ...
                  du service Sivee.pro, un outil en ligne de création et génération de CV professionnels.
                </p>
                <p className="text-primary-700">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">2. Description du service</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">3. Inscription et compte</h2>
                <p className="text-primary-700">
                  Pour utiliser Sivee.pro, vous devez créer un compte en fournissant une adresse email valide.
                </p>
                <p className="text-primary-700">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">4. Utilisation du service</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">5. Propriété des contenus</h2>
                <p className="text-primary-700">
                  Vous restez propriétaire des contenus que vous saisissez dans vos CV (textes, informations personnelles).
                </p>
                <p className="text-primary-700">
                  Les modèles de CV, le design et le code source de Sivee.pro restent la propriété exclusive de l'éditeur.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-primary-700">
                  Des fonctionnalités premium payantes pourront être proposées ultérieurement.
                  Vous serez informé de tout changement tarifaire.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">7. Disponibilité du service</h2>
                <p className="text-primary-700">
                  Sivee.pro s'efforce d'assurer une disponibilité maximale du service,
                  mais ne garantit pas une disponibilité continue et ininterrompue.
                </p>
                <p className="text-primary-700">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">8. Limitation de responsabilité</h2>
                <p className="text-primary-700">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">10. Modification des CGU</h2>
                <p className="text-primary-700">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">11. Droit applicable</h2>
                <p className="text-primary-700">
            ...
            <>
              <section>
                ...
                <p className="text-primary-700">
                  These Terms of Service (ToS) govern the use of Sivee.pro,
                  an online tool for creating and generating professional resumes.
                </p>
                <p className="text-primary-700">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">2. Service Description</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">3. Registration and Account</h2>
                <p className="text-primary-700">
                ...
                <p className="text-primary-700">
                  ...
                  and all activity from your account.
                </p>
              </section>
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">5. Content Ownership</h2>
                <p className="text-primary-700">
                  You retain ownership of the content you enter in your resumes (text, personal information).
                </p>
                <p className="text-primary-700">
                  Resume templates, design, and source code of Sivee.pro remain the exclusive property of the publisher.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-primary-700">
                  ...
                  You will be informed of any pricing changes.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">7. Service Availability</h2>
                <p className="text-primary-700">
                  Sivee.pro strives to ensure maximum service availability,
                  but does not guarantee continuous and uninterrupted availability.
                </p>
                <p className="text-primary-700">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">8. Limitation of Liability</h2>
                <p className="text-primary-700">
              ...
              <section>
                ...
                <p className="text-primary-700">
                  The publisher reserves the right to suspend or delete an account
                  in case of violation of these ToS.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-4">10. ToS Modifications</h2>
                <p className="text-primary-700">
              ...
              <section>
                ...
                <p className="text-primary-700">
                  ...
                  In case of dispute, French courts will have exclusive jurisdiction.
                </p>
              </section>
